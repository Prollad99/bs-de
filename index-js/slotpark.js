...
const url = 'https://techyhigher.com/2021/10/slotpark-free-coins.html';
const currentDate = getCurrentDate();
const dir = 'links-json';
const filePath = path.join(dir, 'slotpark.json');
const htmlFilePath = path.join('_includes', 'slotpark.html');
...
async function main() {
  try {
    ...
    combinedLinks.forEach(link => {
      ...
      htmlContent += `    <span>Slotpark Bonus ${formattedDate}</span>\n`; // Benutzerdefinierter Text mit formatiertem Datum
